...
const Icons = (() => {
    const PATHS = {
        ...
        'traffic-light': '<rect x="8" y="2" width="8" height="20" rx="2"/><circle cx="12" cy="6.5" r="1.5"/><circle cx="12" cy="12" r="1.5"/><circle cx="12" cy="17.5" r="1.5"/>',
    ...
    function create(name, size) {
        ...
        // Statisk ikon-data frå PATHS-tabellen over — ingen brukardata
