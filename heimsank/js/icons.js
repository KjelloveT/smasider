// Heimsank - Lucide SVG icons (inline)
// Bruk: ICON('folder', 18) -> '<svg ...>...</svg>'

const ICON_PATHS = {
  folder: '<path d="M6 14l1.45-2.9A2 2 0 0 1 9.24 10H20a2 2 0 0 1 1.94 2.5l-1.55 6a2 2 0 0 1-1.94 1.5H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.93a2 2 0 0 1 1.66.9l.82 1.2a2 2 0 0 0 1.66.9H18a2 2 0 0 1 2 2v2"/>',
  ...
  microscope: '<path d="M6 18h8"/><path d="M3 22h18"/><path d="M14 22a7 7 0 1 0 0-14h-1"/><path d="M9 14h2"/><path d="M8 6h4"/><path d="M13 10V6.5a.5.5 0 0 0-.5-.5.5.5 0 0 1-.5-.5V3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v2.5a.5.5 0 0 1-.5.5.5.5 0 0 0-.5.5V10c0 1-1 2-2 2h-2c-1 0-2-1-2-2Z"/>',
  ...
  rabbit:   '<path d="M13 16a3 3 0 0 1 2.24 5"/><path d="M18 12h.01"/><path d="M18 21h-8a4 4 0 0 1-4-4 7 7 0 0 1 7-7h.2L9.6 6.4a1 1 0 1 1 2.8-2.8L15.8 7h.2c3.3 0 6 2.7 6 6v1a2 2 0 0 1-2 2h-1a3 3 0 0 0-3 3"/><path d="M16 20c0 .6-.4 1-1 1"/><path d="M14 10h-.01"/>'
};
...
function CAT_ICON(key, size = 16) {
  if (ICON_PATHS[key]) return ICON(key, size);
  return key || '';
}

/**
 * Get Lucide-style SVG markup.
 * @param {string} name - key from ICON_PATHS
 * @param {number} size - width/height in px (default 18)
 * @param {string} extraClass - optional class(es)
...
// Populate any element with [data-icon="name"] on load
