/* ══════════════════════════════════════
   ICONS.JS — Lucide-based SVG icons (local, no CDN)
   All paths from Lucide Icons (ISC license)
   ══════════════════════════════════════ */

const Icons = (() => {
    const PATHS = {
        'armchair': '<path d="M19 9V6a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v3"/><path d="M3 16a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-5a2 2 0 0 1-4 0V9H7v2a2 2 0 0 1-4 0Z"/><path d="M5 18v2"/><path d="M19 18v2"/>',
